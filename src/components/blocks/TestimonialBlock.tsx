                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <div className="min-w-0">
                      <div className="font-medium text-sm leading-snug break-words hyphens-auto text-foreground">{name}</div>
                      {role && (
                        <div className="text-xs text-muted-foreground leading-snug break-words hyphens-auto">{role}</div>
                      )}
                    </div>
