            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="text-left space-y-8">
                        ...
                        <Reveal delay={200}>
                            <h1 className="font-heading text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-[1.05] sm:leading-[0.9]">
                                {t('landing.v6.hero.titlePrefix')}{' '}
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary/60 to-primary animate-gradient-flow bg-[length:200%_auto]">
                                    {t('landing.v6.hero.titleHighlight')}
                                </span>
                            </h1>
                        </Reveal>
