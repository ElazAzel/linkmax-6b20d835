    ...
    return (
        <div className="glass border-primary/20 rounded-[2rem] p-6 sm:p-8 max-w-3xl mx-auto mb-16 relative overflow-hidden group shadow-glass-lg">
            ...
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/10 blur-[60px] rounded-full pointer-events-none" />
                ...
                {t('landing.pricing.calculator.title', 'РљР°Р»СЊРєСѓР»СЏС‚РѕСЂ РІС‹РіРѕРґС‹')}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8 relative z-10 w-full px-2">
                <div className="space-y-4">
                    <Label className="text-xs text-muted-foreground uppercase tracking-wider font-bold">{t('landing.pricing.calculator.leads', 'Р—Р°СЏРІРєРё РІ РјРµСЃСЏС†')}</Label>
                ...
                <div className="space-y-4">
                    <Label className="text-xs text-muted-foreground uppercase tracking-wider font-bold">{t('landing.pricing.calculator.conversion', 'РљРѕРЅРІРµСЂСЃРёСЏ (%)')}</Label>
                    <div className="flex items-center gap-4">
                ...
                <div className="space-y-4">
                    <Label className="text-xs text-muted-foreground uppercase tracking-wider font-bold">{t('landing.pricing.calculator.avgCheck', 'РЎСЂРµРґРЅРёР№ С‡РµРє ($)')}</Label>
                    <div className="flex items-center gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 mt-4 border-t border-border/10 relative z-10">
                <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-background/40">
                    <span className="text-xs text-muted-foreground font-bold uppercase tracking-wider mb-1">{t('landing.pricing.calculator.revenue', 'Р’Р°С€ РґРѕС…РѕРґ:')}</span>
                ...
                <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-background/40 opacity-70">
                    <span className="text-xs text-muted-foreground font-bold uppercase tracking-wider mb-1">{t('landing.pricing.calculator.competitorCost', 'РљРѕРЅРєСѓСЂРµРЅС‚С‹ (8%):')}</span>
                ...
                <div className="flex flex-col items-center justify-center bg-primary/10 rounded-2xl p-4 border border-primary/20 shadow-inner group-hover:bg-primary/15 transition-colors">
                    <span className="text-xs text-primary font-black uppercase tracking-widest mb-1">{t('landing.pricing.calculator.savings', 'Р’Р°С€Р° СЌРєРѕРЅРѕРјРёСЏ:')}</span>
...
export const PricingAurora = ({ onPlanSelect }: { onPlanSelect: (plan: string) => void }) => {
    ...
    const prices = {
        starter: isKZ ? '0 в‚ё' : '$0',
        pro: {
            monthly: isKZ ? '4 350 в‚ё' : '$8.90',
            yearly: isKZ ? '3 045 в‚ё' : '$5.90',
            totalYearly: isKZ ? '36 540 в‚ё' : '$70.80'
        },
    };

    const proFeatures = [
        t('landing.pricing.f1', 'Р’СЃРµ Р±Р»РѕРєРё Р±РµР· РѕРіСЂР°РЅРёС‡РµРЅРёР№'),
        t('landing.pricing.f2', 'РћРЅР»Р°Р№РЅ-Р·Р°РїРёСЃСЊ Рё РјРёРЅРё-CRM'),
        t('landing.pricing.f3', 'Р—Р°СЏРІРєРё СЃСЂР°Р·Сѓ РІ Telegram'),
        t('landing.pricing.f4', 'РџСЂРѕРґР°Р¶Р° С‚РѕРІР°СЂРѕРІ Рё Р±РёР»РµС‚РѕРІ'),
        t('landing.pricing.f5', 'Р’СЃС‚СЂРѕРµРЅРЅС‹Р№ QR-СЃРєР°РЅРµСЂ'),
        t('landing.pricing.f6', 'Р Р°СЃС€РёСЂРµРЅРЅР°СЏ Р°РЅР°Р»РёС‚РёРєР°'),
        t('landing.pricing.f7_new', 'РЎРІРѕР№ РґРѕРјРµРЅ Рё Р±РµР· Р±СЂРµРЅРґРёРЅРіР°'),
        t('landing.pricing.f8_new', 'Р”Рѕ 6 СЃС‚СЂР°РЅРёС† РЅР° Р°РєРєР°СѓРЅС‚'),
    ];
                ...
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <Reveal>
                         <h2 className="text-section-title mb-6">
                            {t('landing.pricing.title', 'РџСЂРѕСЃС‚С‹Рµ С†РµРЅС‹,')}{' '}
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/70">{t('landing.pricing.titleHighlight', 'РјР°РєСЃРёРјСѓРј РІРѕР·РјРѕР¶РЅРѕСЃС‚РµР№')}</span>
                        </h2>
                    </Reveal>
                    <Reveal delay={100}>
                        <p className="text-muted-foreground text-lg mb-8">
                            {t('landing.pricing.subtitle', 'РќР°С‡РЅРёС‚Рµ Р±РµСЃРїР»Р°С‚РЅРѕ. РџРµСЂРµР№РґРёС‚Рµ РЅР° Pro, РєРѕРіРґР° Р±СѓРґРµС‚Рµ РіРѕС‚РѕРІС‹ РјР°СЃС€С‚Р°Р±РёСЂРѕРІР°С‚СЊСЃСЏ.')}
                        </p>
                    </Reveal>
                    ...
                    <Reveal delay={150}>
                        <div className="flex items-center justify-center gap-4">
                            <Label htmlFor="billing-mode" className={cn("text-sm font-medium cursor-pointer", !isYearly && "text-primary")}>
                                {t('landing.pricing.monthly', 'Р•Р¶РµРјРµСЃСЏС‡РЅРѕ')}
                            </Label>
                            <Switch id="billing-mode" checked={isYearly} onCheckedChange={setIsYearly} />
                            <Label htmlFor="billing-mode" className={cn("text-sm font-medium cursor-pointer", isYearly && "text-primary")}>
                                {t('landing.pricing.yearly', 'Р“РѕРґРѕРІРѕР№')}{' '}
                        ...
                        <div className="glass border-primary/30 rounded-[2.5rem] sm:rounded-[3.5rem] p-1 relative transition-all duration-700 hover:-translate-y-3 hover:shadow-glass-lg group">
                            <div className="bg-white/5 backdrop-blur-[40px] rounded-[2.5rem] sm:rounded-[3.3rem] p-6 sm:p-10 md:p-12 h-full flex flex-col relative overflow-hidden">
                                <div className="absolute top-0 right-0 bg-gradient-to-r from-primary to-secondary text-white text-xs font-black px-8 py-3 rounded-bl-[2rem] uppercase tracking-[0.2em] shadow-glass">
                                    {t('landing.pricing.popular', 'РҐРРў')}
                                </div>
                                ...
                                <MagneticButton className="w-full h-14 sm:h-16 md:h-20 rounded-2xl text-sm sm:text-base md:text-lg font-black uppercase tracking-[0.1em] sm:tracking-[0.2em] bg-primary text-white shadow-glass-lg hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98] transition-all" onClick={() => onPlanSelect('pro')}>
                                    {t('landing.pricing.proCta', 'РџРѕРїСЂРѕР±РѕРІР°С‚СЊ Pro Р±РµСЃРїР»Р°С‚РЅРѕ')}
                                </MagneticButton>
                            </div>
                        </div>
                    </div>
                    ...
                    <Reveal delay={300}>
                        <div className="glass border-primary/10 rounded-2xl p-6 mb-6">
                            <h4 className="text-lg font-black mb-2 flex items-center justify-center gap-2">
                                <span className="text-primary">Starter</span> {t('landing.pricing.successFirst', 'РџР»Р°С‚Рё С‚РѕР»СЊРєРѕ Р·Р° СЂРµР·СѓР»СЊС‚Р°С‚')}
                            </h4>
                            <p className="text-xs text-muted-foreground mb-4">
                                {t('landing.pricing.starterDesc', 'РќР°С‡РЅРёС‚Рµ Р·Р° 0в‚ё/РјРµСЃ. РњС‹ Р±РµСЂС‘Рј 7% РєРѕРјРёСЃСЃРёСЋ С‚РѕР»СЊРєРѕ РєРѕРіРґР° РІС‹ СЂРµР°Р»СЊРЅРѕ Р·Р°СЂР°Р±Р°С‚С‹РІР°РµС‚Рµ. Р‘РµР· СЃРєСЂС‹С‚С‹С… РїР»Р°С‚РµР¶РµР№.')}
                            </p>
                            <Button
                                variant="outline"
                            ...
                            >
                                {t('landing.pricing.starterCta', 'РќР°С‡Р°С‚СЊ Р±РµСЃРїР»Р°С‚РЅРѕ')}
                            </Button>
                        </div>
                        <p className="text-[10px] text-muted-foreground/40 font-bold uppercase tracking-[0.2em]">
                            {t('landing.pricing.transactionFeeNote_v2', '* РљРѕРјРёСЃСЃРёСЏ Р·Р° С‚СЂР°РЅР·Р°РєС†РёРё: Starter (7%), Pro (1%)')}
                        </p>
                    </Reveal>
                </div>
            </div>
