    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-2xl p-0">
        <DialogHeader className="p-6 pb-0">
          <DialogTitle>
            {t('legal.paymentTerms', 'Условия оплаты')}
          </DialogTitle>
          <DialogDescription>
            {t('legal.paymentDescription', 'Тарифы, комиссии, подписки и возвраты LinkMAX')}
          </DialogDescription>
        </DialogHeader>
        <ScrollArea className="h-[60vh] px-6 pb-6">
          <div className="pr-4">
            <LegalDocumentContent kind="payment" language={language} variant="modal" />
          </div>
        </ScrollArea>
