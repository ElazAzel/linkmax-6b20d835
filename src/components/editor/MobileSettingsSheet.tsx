                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(val: string) => onGridConfigChange({ columnsDesktop: parseInt(val) })}
                        >
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(val: string) => onGridConfigChange({ columnsMobile: parseInt(val) })}
                        >
                          <SelectTrigger className="mt-2 bg-card/60 backdrop-blur-xl border-border/30 rounded-xl">
                            <SelectValue />
                          </SelectTrigger>
                ...
                {userId && pageId ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-sm text-muted-foreground max-w-[200px]">
                      {t('collaboration.authRequired', 'Войдите, чтобы управлять коллаборациями')}
                    </p>
                  </div>
                )}
              </TabsContent>
