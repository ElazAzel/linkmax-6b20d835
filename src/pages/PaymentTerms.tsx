...
const PaymentTerms = () => {
  ...
  const seoTitle =
    lang === 'ru'
      ? 'Условия оплаты — LinkMAX'
      : lang === 'kk'
        ? 'Төлем шарттары — LinkMAX'
        : 'Payment Terms — LinkMAX';
  const seoDescription =
    lang === 'ru'
      ? 'Условия оплаты и возвратов для тарифов LinkMAX.'
      : lang === 'kk'
        ? 'LinkMAX тарифтері үшін төлем және қайтару шарттары.'
        : 'Payment and refund terms for LinkMAX plans.';

  const getPaymentTermsContent = () => {
    if (lang === 'en') {
      return (
        <>
          <h1 className="text-3xl font-bold mb-6">Payment Terms for LinkMAX.my Users</h1>
          ...
          <p className="mb-2">1.1. These Payment Terms (hereinafter - "Payment Terms") govern the payment procedure for LinkMAX.my platform services (hereinafter - "Platform", "LinkMAX.my") by individuals and representatives of legal entities.</p>
          <p className="mb-2">1.2. Payment Terms are an integral part of the User Agreement and apply to all paid services and plans of LinkMAX.my.</p>
          <p className="mb-4">1.3. By paying for LinkMAX.my services, the User confirms that they have read and agree to the User Agreement, Privacy Policy, and these Payment Terms.</p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">2. Plans and Pricing</h2>
          <p className="mb-2">2.1. LinkMAX.my services are provided on a subscription model for plans (e.g., PRO, BUSINESS).</p>
          ...
          <p className="mb-2">6.1. Refunds for LinkMAX.my digital services are made in cases and in the manner established by the current legislation of the Republic of Kazakhstan and described in the User Agreement.</p>
    ...
    if (lang === 'kk') {
      return (
        <>
          <h1 className="text-3xl font-bold mb-6">LinkMAX.my пайдаланушылары үшін төлем шарттары</h1>
          ...
          <p className="mb-4">Осы Төлем шарттары LinkMAX.my платформасы қызметтеріне төлем тәртібін реттейді.</p>
    ...
    return (
      <>
        <h1 className="text-3xl font-bold mb-6">Условия оплаты для пользователей LinkMAX.my</h1>
        ...
        <p className="mb-2">1.1. Настоящие Условия оплаты (далее - «Условия оплаты») регулируют порядок оплаты услуг платформы LinkMAX.my (далее - «Платформа», «LinkMAX.my») физическими лицами и представителями юридических лиц.</p>
        <p className="mb-2">1.2. Условия оплаты являются неотъемлемой частью Пользовательского соглашения и применяются ко всем платным сервисам и тарифам LinkMAX.my.</p>
        <p className="mb-4">1.3. Осуществляя оплату услуг LinkMAX.my, Пользователь подтверждает, что ознакомился и согласен с Пользовательским соглашением, Политикой конфиденциальности и настоящими Условиями оплаты.</p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Тарифы и стоимость услуг</h2>
        <p className="mb-2">2.1. Услуги LinkMAX.my предоставляются по модели подписки на тарифные планы (например, PRO, BUSINESS).</p>
        ...
        <p className="mb-2">6.1. Возврат денежных средств за цифровые услуги LinkMAX.my осуществляется в случаях и порядке, установленных действующим законодательством Республики Казахстан и описанных в Пользовательском соглашении.</p>
