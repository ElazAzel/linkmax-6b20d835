...
export const CANONICAL_EVENTS = {
  ...
  booking_details_submitted: 'booking_details_submitted',
  deposit_instructions_viewed: 'deposit_instructions_viewed',
  deposit_payment_started: 'deposit_payment_started',
...
export const TAXONOMY_STORAGE_MAP: Record<CanonicalEvent, AnalyticsEventType> = {
  ...
  booking_slot_selected: 'click',
  booking_details_submitted: 'click',
  deposit_instructions_viewed: 'click',
  deposit_payment_started: 'click',
  deal_created: 'click',
