...
## Slide 5: Бизнес-модель (Two-tier Transactional SaaS)

**Гибридная модель: подписка + транзакционная комиссия. Мы зарабатываем, когда зарабатывает юзер.**

1. **Starter (Free)**: 0 ₸/мес + **7% комиссия** с транзакций. Полный продукт, CRM и Fintech для тех, кто делает первые продажи.
2. **Pro (~$13 / 6 000 ₸ в месяц)**: Подписка + **1% комиссия**. Кастомный домен, премиум-блоки, расширенные лимиты. Окупается уже после ~60 000 ₸ / $130 оборота — одной типичной записи.
3. **Fintech (Q4 2026)**: Расширение Take Rate через собственные кошельки, Kaspi QR и WhatsApp Business API.
