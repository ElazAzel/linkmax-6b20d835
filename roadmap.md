...
- [ ] Оптимизация проекта (запрошено 2026-09-20): аудит производительности/размера бандла, код-сплиттинг, лишние зависимости и рендеры. DB-зависимые пункты ниже остаются заблокированными.
