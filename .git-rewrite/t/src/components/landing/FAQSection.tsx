...
export function FAQSection() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: t('landing.faq.q2.answer', 'Базовый тариф бесплатен навсегда и включает неограниченные ссылки, базовые блоки и 3 AI-запроса в день. Премиум тарифы начинаются от $3.15/месяц при годовой оплате.')
    },
    {
    ...
    },
    {
      ...
      answer: t('landing.faq.q5.answer', 'В тарифе Business доступна интеграция с Stripe и Kaspi Pay. Вы можете продавать товары, услуги и цифровые продукты прямо со своей страницы.')
    },
    {
    ...
    },
    {
      ...
      answer: t('landing.faq.q8.answer', 'Да, LinkMAX включает встроенную аналитику просмотров и кликов. В Pro тарифе доступен мини-CRM до 100 лидов/месяц, а в Business — полноценная CRM без ограничений.')
    },
    {
      question: t('landing.faq.q9.question', 'Можно ли установить пиксели Meta, TikTok, Google?'),
      answer: t('landing.faq.q9.answer', 'Да, в Pro и Business тарифах вы можете добавить пиксели для ретаргетинга и отслеживания конверсий: Meta Pixel, TikTok Pixel, Google Analytics и другие.')
    },
    {
      question: t('landing.faq.q10.question', 'Какие интеграции поддерживает LinkMAX?'),
      answer: t('landing.faq.q10.answer', 'LinkMAX интегрируется с Telegram для уведомлений, Stripe и Kaspi Pay для платежей, Google Calendar для записи. Также поддерживаются все социальные сети и мессенджеры.')
    },
    {
    ...
    {
      question: t('landing.faq.q12.question', 'Насколько безопасны данные на LinkMAX?'),
      answer: t('landing.faq.q12.answer', 'Мы используем шифрование SSL, защищённые серверы и соответствуем стандартам безопасности. Ваши данные и данные ваших клиентов в безопасности.')
    },
    {
      question: t('landing.faq.q13.question', 'Можно ли посмотреть примеры страниц?'),
      answer: t('landing.faq.q13.answer', 'Да! В нашей галерее представлены реальные страницы пользователей из разных ниш: барберы, фотографы, тренеры, психологи, магазины и другие. Это поможет вам найти вдохновение.')
    },
    {
      question: t('landing.faq.q14.question', 'Чем LinkMAX лучше Linktree и Taplink?'),
      answer: t('landing.faq.q14.answer', 'LinkMAX предлагает AI-генерацию контента, 0% комиссии с продаж, встроенную CRM, геймификацию (достижения, квесты) и современный дизайн. Плюс поддержка русского и казахского языков.')
    }
  ];
